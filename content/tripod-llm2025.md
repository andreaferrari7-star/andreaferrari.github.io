...
- Il **TRIPOD-LLM Statement** (*Transparent Reporting of a multivariable model for Individual Prognosis Or Diagnosis - Large Language Models*) è lo standard metodologico internazionale di riferimento per la rendicontazione trasparente, rigorosa e riproducibile degli studi biomedici e clinici che sviluppano, ottimizzano (*fine-tuning* / *prompting*) o valutano Large Language Models ([LLM](concetti/large-language-models.md)) e sistemi conversazionali basati su intelligenza artificiale generativa in sanità.
...
- **Inadeguatezza degli Standard di Reporting Preesistenti:** Le linee guida per classificatori supervisionati (TRIPOD 2015, TRIPOD+AI 2024, MI-CLAIM) non intercettano le specificità metodologiche dei modelli generativi autoregressivi:
  - Scelte di iperparametri nell'[addestramento e fine-tuning](concetti/supervised-fine-tuning.md);
...
| **[TRIPOD+AI (2024)](concetti/TRIPOD_AI2024.md)** | Modelli Predittivi di Regressione e ML Classico | **27 macro / 52 sotto-item** (Matrice D, E, D;E) | Calibrazione continua, utilità clinica (Decision Curve Analysis), fairness pervasiva, non-esistenza del modello validato una volta per tutte. |
| **[CHART (2025)](concetti/chart-reporting-guideline.md)** | Chatbot per Consigli Sanitari (*Chatbot Health Advice*) | **12 macro / 39 sotto-item** | Sessioni di chat multi-turno, sicurezza delle raccomandazioni cliniche, accecamento valutatori, diagramma di flusso query. |
| **[ELEVATE-GenAI (2025)](concetti/elevate-genai-framework.md)** | Ricerca Economico-Sanitaria ed Esiti (HEOR) | **10 domini / Scoring a 30 punti** | Modelli markoviani, de-identificazione PHI, living guideline con livelli di maturità metrologica. |
...
- Standard di Reporting Correlati: [tripod-ai2024](tripod-ai2024.md), [chart-reporting-guideline](chart-reporting-guideline.md), [elevate-genai-framework](elevate-genai-framework.md), [gamer-reporting-guideline](gamer-reporting-guideline.md), [living-guidelines-in-health-ai](living-guidelines-in-health-ai.md)
- Nuove Pagine Concettuali Dedicate: [modular-reporting-framework-llm](modular-reporting-framework-llm.md), [task-specific-generative-evaluation-healthcare](task-specific-generative-evaluation-healthcare.md)
- Concetti Metodologici e Clinici: [tripod-llm-reporting-guideline](tripod-llm-reporting-guideline.md), [dataset-integrity-and-contamination-in-medical-ai](dataset-integrity-and-contamination-in-medical-ai.md), [clinical-chain-of-thought-paradox](clinical-chain-of-thought-paradox.md), [human-oversight-and-liability-in-clinical-ai](human-oversight-and-liability-in-clinical-ai.md), [accuratezza-vs-fattualita-in-genai](accuratezza-vs-fattualita-in-genai.md), [prompt-experiment-gap-in-clinical-ai](prompt-experiment-gap-in-clinical-ai.md), [stochasticity-management-in-clinical-llms](stochasticity-management-in-clinical-llms.md)
