...
# Three-Layer Morphological Framework in Mental Health AI
...
| Scelta di Design | Vantaggi Operativi | Rischi Clinici & Limiti | Livello |
| :--- | :--- | :--- | :--- |
| **Closed-Source API (GPT-4)** | Immediatezza di integrazione, fluenza generativa, flessibilità. | Dipendenza da terzi, opacità dati, violazioni GDPR, drift. | **L1** |
| **Open-Source Fine-Tuned (MentalRoBERTa)** | Accuratezza discriminativa, determinismo, privacy, costi bassi. | Incapacità di generare dialoghi aperti estesi. | **L1** |
...
2.  **Il Ruolo Critico dell'Interfaccia (L2):** Come dimostrato dalla letteratura HCI, le modalità comunicative dell'interfaccia determinano se l'utente svilupperà un'alleanza funzionale o una dipendenza alienante.
