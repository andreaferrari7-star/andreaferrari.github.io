---
tags: [defense-attorney-technique, dat, cognitive-restructuring, ristrutturazione-cognitiva, cbt, de-oliveira, maieutica-clinica]
...
```mermaid
flowchart LR
    subgraph DAT ["Defense Attorney Technique (DAT)"]
        D["1. Difesa (Defense)<br>Paziente come Avvocato Difensore:<br>Esibizione prove fattuali a favore del bias"]
        P["2. Accusa (Prosecution)<br>Terapeuta come Pubblico Ministero:<br>Contro-interrogatorio & Contro-evidenze"]
        V["3. Verdetto (Verdict)<br>Valutazione Giudiziaria Interna:<br>Risoluzione & Pensiero Alternativo Adattivo"]
        D --> P --> V
    end
```
...
## Relazioni
- Vedi anche: [[2504-17238v1]], [[crdial-framework]], [[crispers-models-and-dataset]], [[cbt-dialogue-systems-and-tools]], [[automated-cognitive-restructuring]], [[active-ai-therapeutic-agent]]
