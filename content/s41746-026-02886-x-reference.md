...
- **Obiettivo Scientifico:** Isolare l'efficacia clinica specifica degli **agenti conversazionali guidati da intelligenza artificiale (AI Conversational Agents - CAs)** dotati di Natural Language Processing ([NLP](concetti/large-language-models.md)) o Machine Learning e fondati esplicitamente sulla **Terapia Cognitivo-Comportamentale (CBT)**, superando l'eterogeneità concettuale e tecnologica delle meta-analisi precedenti che aggregavano indistintamente sistemi deterministici basati su regole (*rule-based*) e approcci teorici eterogenei.
...
flowchart TD
    ...
    subgraph Moderators ["Scoperte e Moderatori Chiave"]
        M1[Vantaggio Multimodale](concetti/concetti/concetti\multimodal-advantage-in-depression-ai.md):</b><br/>Multimodale g = 0.82 vs Unimodale g = 0.24 (P < .001)"]
        M2[Effetto Diluizione Psicoeducazione](psychoeducation-dilution-effect-in-ai.md):</b><br/>Senza Psicoeducazione g = 0.47 vs Con g = 0.19 (P = .045)"]
        ...
        M5[Deficit di Esposizione](concetti/exposure-therapy-deficit-in-mental-health-ai.md):</b><br/>Solo 1/15 RCT include esposizione -> Fallimento su ansia"]
...
| **Tipologia di Campione** | **Subclinico**<br>Clinico<br>Non clinico | 8<br>3<br>2 | **0.47 [ 14.64 (.04)<br>0.40 (.82)<br>0.43 (.51) | $Q_b = 5.25$ ($P = .07$) | [subclinical-depression-window-of-opportunity|Finestra subclinica](concetti/subclinical-depression-window-of-opportunity.md): massima responsività nel distress precoce. |
...
La Tabella 1 del lavoro originale censisce i 15 studi analizzati, evidenziando le architetture computazionali ([Retrieval vs Generative](concetti/retrieval-vs-generative-clinical-chatbots.md)) e i componenti tecnici impiegati:
...
Hang et al. (2026) confermano e consolidano il fenomeno dell'[Exposure Therapy Deficit in Mental Health AI](concetti/exposure-therapy-deficit-in-mental-health-ai.md):
...
- [Sistemi di Recupero vs Architetture Generative in Sanità Mentale](concetti/retrieval-vs-generative-clinical-chatbots.md)
...
- [Efficacia degli Agenti Conversazionali AI per la Salute Mentale Giovanile (Feng et al., 2025)](concetti/jmir-v27i1e69639.md)
- [AI-Guided CBT for Depression and Anxiety (Stojanovic et al., 2026)](concetti/sintesi/sintesi\healthcare-14-02334.md)
