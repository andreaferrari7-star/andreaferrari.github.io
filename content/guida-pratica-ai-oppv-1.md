...
Il documento analizza il quadro normativo di riferimento su quattro livelli (Deontologia, GDPR, Legge 219/2017, AI Act/EHDS) e definisce quattro condizioni di liceità inderogabili:

1.  **Tutela Dati Sensibili:** Art. 9 GDPR, superamento della fallacia della pseudonimizzazione parziale.
2.  **Segretezza & Riservatezza:** Divieto di retraining, utilizzo di server SEE, obbligo di controllo.
3.  **Trasparenza & Consenso:** Estensione del patto fiduciario tramite informativa modulare.
4.  **Responsabilità Esclusiva & Human-in-the-Loop:** Divieto di delega decisionale, validazione critica umana obbligatoria.

La guida include inoltre un vademecum operativo per le piattaforme (Zoom, Teams, Meet, LLM, strumenti di trascrizione) con l'imposizione di configurazioni di *hardening* specifico per mantenere la conformità.

### Riferimenti Bibliografici
*   Ordine delle Psicologhe e degli Psicologi del Veneto (OPPV), Gennaio 2026, *Guida Operativa all'Utilizzo dell'AI nella Pratica Professionale* (Versione 1 e 1.1).
