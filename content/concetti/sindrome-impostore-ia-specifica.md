...
**Sources**: Signorini & Paganin (2026, *Frontiers in Psychology*, DOI: 10.3389/fpsyg.2026.1690291); Festinger (1957); `AI in Psicoterapia 2023-2026.docx`.
**Last updated**: 2026-08-27
---

## Meccanismo Eziologico: Il Collasso della Giustificazione dello Sforzo
...
```mermaid
flowchart TD
    subgraph Classica ["Sindrome dell'Impostore Classica"]
        C1["Alto Sforzo / Lungo Studio"] --> C2["Risultato Clinico Eccellente"]
        C2 --> C3["Attribuzione Errata a Fortuna / Tempismo"]
        C3 --> C4["Senso di Inadeguatezza Nonostante lo Sforzo Reale"]
    end

    subgraph IASpecifica ["Sindrome dell'Impostore IA-Specifica"]
        I1["Minimo Sforzo (Semplice Prompt)"] --> I2["Output Clinico Sofisticato & Fluido"]
        I2 --> I3["Collasso dell'Effort Justification"]
        I3 --> I4["Percezione di Inautenticità Strutturale ('Non l'ho scritto io')"]
        I4 --> I5["Trasmutazione Identitaria: da 'Generatore' a 'Editor/Curatore'"]
    end
```

---

## Differenze tra Sindrome Classica e Variante IA-Specifica

| Dimensione | Sindrome dell'Impostore Classica | Sindrome dell'Impostore IA-Specifica |
| :--- | :--- | :--- |
| **Trigger Eziologico** | Perfezionismo, standard interni elevati | Utilizzo di sistemi di GenAI |
| **Ruolo dello Sforzo** | Sforzo massiccio, ma svalutato soggettivamente | **Assenza reale di sforzo cognitivo prolungato** |
| **Percezione dell'Autorialità** | Il clinico riconosce di aver redatto l'opera | Il clinico si sente un mero *procuratore/editor* |
| **Modello di Intelligenza** | *Effort-based Intelligence* (Intelligenza basata sullo sforzo) | ***Access-based Intelligence* (Intelligenza basata sull'accesso tecnologico)** |
| **Confronto Sociale** | Verso colleghi senior o pari | Verso l'infallibilità sintattica e la velocità dell'algoritmo |

---

## Conseguenze sull'Identità Professionale dello Psicoterapeuta

1. **Erosione dell'Autoefficacia Diagnostica**:
   - Misurando la propria "lentezza umana" e le proprie incertezze contro la prontezza sintatticamente impeccabile e la memoria enciclopedica del modello linguistico, il professionista sviluppa un dubbio corrosivo sulla legittimità delle proprie competenze cliniche.
