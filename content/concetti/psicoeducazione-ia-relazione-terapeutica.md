...
```mermaid
graph TD
    A[Indagine Clinica in Seduta] --> B{Tipologia di Utilizzo}
    B -->|Disfunzionale| C[Mantenimento Sintomatologico<br>Rimuginio, Rassicurazione, Evitamento]
    B -->|Funzionale / Supervisionato| D[Supporto Adattivo<br>Homework, Diario, Psicoeducazione]
    C --> E[Psicoeducazione & Ristrutturazione Cognitiva]
    D --> F[Integrazione nell'Alleanza Terapeutica]
```
