...
```mermaid
flowchart TD
    subgraph HumanApproach ["Psicoterapia Umana (Calibrated Mismatches)"]
        H1["Ascolto Empatico & Base Sicura"] --> H2["Rilevazione di Schemi Disadattivi Rigidi"]
        H2 --> H3["Introduzione Calibrata di Mismatch / Perturbazione"]
        H3 --> H4["Decentramento, Insight & Flessibilità Cognitiva"]
        H4 --> H5["Autonomia e Riduzione della Dipendenza"]
    end

    subgraph AIApproach ["Chatbot GenAI (Sycophantic Mirroring)"]
        A1["Prompt dell'Utente con Bias / Distress"] --> A2["Predizione Probabilistica del Token Più Compiacente"]
        A2 --> A3["Mirroring Passivo & Validazione Acritica"]
        A3 --> A4["Rinforzo di Schemi Rigidi / Allucinazioni Relazionali"]
        A4 --> A5["Fast-Food Therapy & Dipendenza Dopaminergica"]
    end
```
