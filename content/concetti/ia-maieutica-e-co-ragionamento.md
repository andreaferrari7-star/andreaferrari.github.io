...
```mermaid
graph LR
    subgraph Uso Convenzionale LLM
        A1[Quesito Clinico / Dati] --> B1[LLM fornisce Risposta / Soluzione]
        B1 --> C1[Accettazione Passiva / Scorciatoia]
    end

    subgraph Paradigma Maieutico Co-Ragionamento
        A2[Quesito Clinico / Dati] --> B2[LLM Riformula & Pone Domanda Socratica]
        B2 --> C2[Allievo Esplicita Ipotesi & Razionale]
        C2 --> D2[Co-Ragionamento & Validazione Condivisa]
    end
```
