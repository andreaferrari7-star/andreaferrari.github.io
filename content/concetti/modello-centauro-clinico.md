---
title: Modello Centauro Clinico (Centaur Clinical Model)
...
```mermaid
graph LR
    Clinico["Clinico Umano (Empatia, Corporeità, Saggezza, Giudizio Etico)"] 
    IA["Co-pilota IA / RAG (Analisi Testuale Massiva, Pattern Recognition, Feedback)"]
    Centauro["Centauro Clinico (Maggiore Efficacia, Minori Blind Spots, Minore Dropout)"]

    Clinico <-->|Sinergia & Supervisione Attiva| IA
    Clinico --> Centauro
    IA --> Centauro
```
