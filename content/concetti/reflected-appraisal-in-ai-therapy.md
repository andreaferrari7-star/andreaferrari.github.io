---
tags: [reflected-appraisal, concetto-di-se, genuineness-gap, intersoggettivita, esperienze-emotive-correttive, autostima, psicoterapia-ia]
...
```mermaid
flowchart TD
    subgraph SettingUmano ["Interazione Terapeuta Umano"]
        H1["Empatia & Accettazione Autentica"] --> H2["Percezione di Scelta Volitiva dell'Altro"]
        H2 --> H3["Interiorizzazione del Giudizio Positivo (Reflected Appraisal)"]
        H3 --> H4["Esperienza Emotiva Correttiva & Ristrutturazione del Sé"]
    end

    subgraph SettingIA ["Interazione Agente Artificiale (LLM)"]
        AI1["Empatia Sintetica & Validazione Algoritmica"] --> AI2["Consapevolezza: Risposta Programmata / Pattern Matching"]
        AI2 --> AI3["(-) Self-Concept Contingency (Il Sé non dipende dal bot)"]
        AI3 --> AI4["Depotenziamento dell'Esperienza Correttiva"]
    end
```
