...
```mermaid
flowchart TD
    P[Paziente in Seduta] -->|Condivisione di Aspetti del Sé / Parti Interne| T[Psicoterapeuta]
    T -->|Prompting Clinicamente Calibrato| AI[Modello GenAI Multimodale]
    AI -->|Generazione Real-Time Skyboxes 360°| VR[Visore di Realtà Virtuale]
    VR -->|Immersione Fenomenologica & Embodiment| P
    P -->|Dialogo tra Parti, Esplicitazione Conflitti, Self-Compassion| Outcome[Trasformazione & Ristrutturazione Identitaria]
```
