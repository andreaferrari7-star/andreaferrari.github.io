...
```mermaid
graph TD
    A[Incertezza / Complessità Clinica in Seduta] --> B[Attivazione Schemi Personali del Terapeuta]
    B -->|Mancata Consapevolezza| C[Uso Difensivo dell'IA<br>Ricerca di Autorassicurazione]
    C --> D[Suggestionabilità Algoritmica & Confirmation Bias]
    B -->|Autosupervisione Metacognitiva| E[Uso Critico / Co-Reasoning<br>Human-in-the-Reasoning]
    E --> F[Espansione Ipotesi Differenziali & Scaffolding]
```
