...
```mermaid
flowchart TD
    subgraph DimensioniTecnostress ["Dimensioni del Tecnostress"]
        T1["Techno-Overload: Carico cognitivo da correzione di allucinazioni ed errori"]
        T2["Techno-Invasion: Iperconnessione H24 e dissoluzione dei confini privati"]
        T3["Techno-Complexity: Difficoltà ad aggiornare e integrare continui software"]
        T4["Techno-Insecurity: Timore di inadeguatezza o sostituzione professionale"]
    end

    subgraph ConseguenzeCliniche ["Impatti sulla Pratica Terapeutica"]
        C1["Paradosso della Sovra-Documentazione: Pletora di note prolisse e inutili"]
        C2["Erosione della Presenza Terapeutica: Distrazione da schermi e dashboard"]
        C3["Dipendenza Epistemica: L'IA come 'Quasi-Collega' Infallibile"]
    end

    DimensioniTecnostress --> ConseguenzeCliniche
```
