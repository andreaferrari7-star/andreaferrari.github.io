---
tags: [status-ontologico, status-socioculturale, intersoggettivita, legittimazione-istituzionale, genuineness-gap, credibility-gap, fattori-comuni]
...
```mermaid
classDiagram
    class TerapeutaUmano {
        +Status Ontologico: Essere Vivente Cosciente
        +Status Socioculturale: Professionista Sanitario Legittimato
        +Intersoggettività Reale
        +Autorità Epistemica & Deontologica
        +Reflected Appraisal Autentico
    }
    class AgenteArtificiale {
        -Natura Algoritmica & Probabilistica
        -Assenza di Stati Interni & Coscienza
        -Mancanza di Sanzione Istituzionale Primaria
        -Genuineness Gap
        -Credibility Gap
    }
    TerapeutaUmano <|-- AgenteArtificiale : Disparità Strutturale
```
