...
```mermaid
graph TD
    subgraph CircuitoNeurobiologico ["Attivazione Neurobiologica (Social Reward)"]
        D1["Disponibilità H24 & Risposta Istantanea"] --> D2["Attivazione Vie Dopaminergiche Mesocorticolimbiche"]
        D2 --> D3["Rinforzo Positivo Intermittente (Feedback Calibrato)"]
        D3 --> D4["Craving & Uso Compulsivo / Dipendenza Comportamentale"]
    end

    subgraph ImpattoPsicologico ["Impatto sull'Autonomia del Paziente"]
        P1["Fuga dalla Tolleranza della Frustrazione"]
        P2["Delega Cognitiva e Mancata Mentalizzazione"]
        P3["Cronicizzazione della Dipendenza dallo Strumento"]
    end
