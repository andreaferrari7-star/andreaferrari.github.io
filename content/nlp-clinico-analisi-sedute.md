...
- **Utilizzo di modelli linguistici:** Analisi e post-processamento di trascrizioni di sedute terapeutiche reali (estrazione reti causali, riassunti clinici) e impiego di Small Language Models (SLM) in locale (*on-device*) per garantire la totale privacy dei dati sensibili del paziente.
