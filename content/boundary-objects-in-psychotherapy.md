---
tags: [boundary-objects, psychotherapy-systems, relational-mediators, sociotechnical-theory, winnicott-potential-space, human-ai-interaction, interdisciplinary-care]
...
```mermaid
flowchart TD
    subgraph TheoryComparison ["Confronto tra Prospettive Sociotecniche"]
        ANT["Actor-Network Theory (ANT)<br>• Agency simmetrica umani / non-umani<br>• Rischio di diffondere l'etica clinica<br>• Cerca punti di passaggio obbligati rigidi"]
        MT["Mediation Theory Classica<br>• Scambio informativo e simbolico lineare<br>• Limiti nella fluidità del potere relazionale"]
        BO["Boundary-Object Theory (Star & Winnicott)<br>• Plasticità e Coerenza condivisa<br>• Spazio potenziale per ermeneutica aperta<br>• Salvaguarda la responsabilità del terapeuta"]
    end

    subgraph DynamicAI ["Evoluzione dell'Oggetto di Confine con LLM"]
        SBO["Oggetto Statico Passivo<br>(EHR, scale psicometriche fisse)"]
        -->|Transizione Computazionale| DBO["Oggetto di Confine Dinamico / Agente Relazionale<br>(LLM con sintonizzazione contestuale e memoria distillata)"]
    end
```
