...
# Causal Discovery e Machine Learning per i Target Psicosociali (Causal Discovery and Machine Learning for Psychosocial Targets)
...
## Evidenze Empiriche e Scoperte Meccanicistiche
...
## Confronto Metodologico: Causal ML vs Machine Learning Tradizionale

| Dimensione | Machine Learning Predittivo Correlazionale (Supervised) | Causal Machine Learning (GFCI / SEM / Bayesian Networks) |
| :--- | :--- | :--- |
| **Obiettivo Primario** | Massimizzare l'accuratezza predittiva ($R^2$, AUC, RMSE) minimizzando l'errore empirico | Identificare i nodi causali e la direzione dei legami strutturali ($A \to B$) |
| **Natura dei Pattern** | Cattura associazioni statistiche superficiali, incluse correlazioni spurie | Isola invarianze strutturali e controlla formalmente i confondenti non osservati |
| **Robustezza al Domain Shift** | Fragile: le correlazioni cambiano quando cambia il contesto o la popolazione clinica | Elevata: le relazioni causali autentiche rimangono invarianti tra contesti |
| **Prescrizione Terapeutica** | Non informativa sul "cosa accade se intervengo": la correlazione non garantisce efficacia | **Prescrittiva:** identifica con precisione i target di intervento ad alto rendimento clinico |
| **Interpretazione Clinica** | Spesso etichettato come "scatola nera" (*Black-Box*) | **Trasparente e Spiegabile:** rappresentato tramite grafi visibili e interpretabili (DAG) |

---

## Implicazioni per la Psicoterapia CBT e la Riabilitazione Psichiatrica

1. **Riformulazione dei Piani di Trattamento nella Psicosi:**
   - I clinici non devono limitarsi a trattare i sintomi psicotici positivi o ad attendere che la riduzione della sintomatologia produca passivamente recupero funzionale.
   - Il focus terapeutico deve orientarsi precocemente sulla **riattivazione del sistema di ricompensa sociale e sulla motivazione intrinseca**, impiegando tecniche mutuate dalla CBT per i sintomi negativi, dal *Behavioral Activation* e dalla terapia focalizzata sulla compassione (*CFT*).
2. **Progettazione Sequenziale del Social Cognition Training (SCT):**
   - Rispettando la gerarchia causale dimostrata dalle reti bayesiane, i moduli riabilitativi devono seguire una sequenza tassonomica rigorosa:
     - *Modulo 1:* Esercizi di identificazione e denominazione dei propri stati emotivi e bisogni (ToM in 1° persona);
     - *Modulo 2:* Decodifica delle intenzioni dell'interlocutore diretto (ToM in 2° persona);
     - *Modulo 3:* Analisi di interazioni sociali complesse a più protagonisti e credenze di terzi (ToM allocentrica).
3. **Integrazione nei Sistemi di Decision Support Clinico:**
   - I grafi causali possono essere incorporati nei sistemi di supporto alle decisioni cliniche basati su IA, consentendo di simulare l'effetto previsto di specifici interventi terapeutici prima della loro implementazione in vivo.
