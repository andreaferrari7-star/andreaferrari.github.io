...
- **Framework:** Insieme di raccomandazioni e linee guida procedurali per integrare modelli linguistici di grandi dimensioni (LLM) ed elaborazioni bibliometriche nella conduzione di Scoping Review e Revisioni Strutturate della Letteratura (SLR).
