...
- Dati emersi: Lo standard TRIPOD-LLM (2025) sostituisce le checklist monolitiche (es. CONSORT/STROBE) con un'architettura modulare (14 macro-item universali + 5 specialistici), migliorando l'aderenza alla trasparenza nelle pubblicazioni di AI clinica.
- Limiti tecnici: Il framework rischia l'incompleta copertura se i task emergenti (es. agenti autonomi multimodali) non vengono aggiornati regolarmente tramite il modello di *living guideline*.
