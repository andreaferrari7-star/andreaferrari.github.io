...
- **Prima revisione sistematica e meta-analisi globale** specificamente focalizzata sull'efficacia degli **agenti conversazionali guidati da intelligenza artificiale (AI-driven Conversational Agents - CAs)** dotati di Natural Language Processing ([NLP](concetti/large-language-models.md)) o Machine Learning (ML) nel miglioramento della salute mentale di **adolescenti e giovani adulti (12–25 anni)**.
...
flowchart TD
    ...
    subgraph CoreConcepts ["Costrutti Chiave Formalizzati"]
        C1[Finestra di Opportunità Subclinica](concetti/subclinical-depression-window-of-opportunity.md):</b><br/>Massima efficacia terapeutica nei quadri subclinici (g = 0.74) vs universali (g = 0.04)"]
        C2[Deficit di Esposizione Comportamentale](concetti/exposure-therapy-deficit-in-mental-health-ai.md):</b><br/>Fallimento su ansia e stress per assenza di protocolli di esposizione in vivo/immaginativa"]
...
### 2. La [Finestra di Opportunità Subclinica](concetti/subclinical-depression-window-of-opportunity.md)
...
### 3. Il [Deficit di Esposizione Comportamentale](concetti/exposure-therapy-deficit-in-mental-health-ai.md) per Ansia e Stress
...
## Relazioni
- [subclinical-depression-window-of-opportunity](subclinical-depression-window-of-opportunity.md): Finestra di opportunità clinica e massima efficacia dei chatbot AI per la depressione subclinica giovanile.
- [exposure-therapy-deficit-in-mental-health-ai](exposure-therapy-deficit-in-mental-health-ai.md): Discrepanza di efficacia tra depressione e ansia/stress dovuta all'assenza di moduli di esposizione comportamentale negli agenti AI.
- [jmir-v27-e78238](jmir-v27-e78238.md): Meta-analisi di Zhang et al. (2025) sul confronto tra chatbot social-oriented e task-oriented nella salute mentale.
- [jmir-v27-e79850](jmir-v27-e79850.md): Meta-analisi di Feng et al. (2025) sulle affordance digitali e distress corporeo negli adolescenti e giovani adulti (AYA).
- [cpp-33-e70242-1](cpp-33-e70242-1.md): Revisione sistematica di Orrù & Mannarini (2026) su trattabilità algoritmica e modelli NLP in psicologia clinica.
- [aya-digital-mental-health-affordances](aya-digital-mental-health-affordances.md): Proprietà d'uso e anonimato dei chatbot per la popolazione giovanile.
- [clinical-readiness-gap-in-mh-chatbots](concetti/concetti/concetti\clinical-readiness-gap-in-mh-chatbots.md): Il divario di prontezza clinica tra performance conversazionale ed efficacia clinica evidence-based.
- [ai-enhanced-cbt](concetti/concetti/concetti\concetti/concetti\ai-enhanced-cbt.md): Integrazione di tecniche cognitivo-comportamentali negli agenti conversazionali.
- [modello-centauro-clinico](concetti/concetti/concetti\modello-centauro-clinico.md): Cooperazione human-in-the-loop per l'integrazione di strumenti digitali nella cura a gradini.
