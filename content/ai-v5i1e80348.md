...
La revisione sistematica PRISMA 2020, condotta da Ha Na Cho, Jiayuan Wang, Di Hu e Kai Zheng (Università della California, Irvine; pubblicata su *JMIR AI* 2026;5:e80348, doi: 10.2196/80348), sintetizza in modo esaustivo 20 studi originali pubblicati tra il 2020 e il maggio 2025 dedicati allo sviluppo, alle tecniche computazionali, ai framework di valutazione e alle salvaguardie etico-regolatorie di chatbot e sistemi agentici basati su [large-language-models](large-language-models.md) (LLM) per il counseling e il supporto in salute mentale.
...
3.  **Sicurezza ed Etica:** Tramite il *[traffic light framework](traffic-light-quality-appraisal-clinical-ai.md)*, l'85% degli studi non documenta protocolli di escalation per il rischio suicidario, evidenziando gravi carenze nel dominio "Ethics & Safety".
