---
tags: [psicoterapia, processi-di-cambiamento, pbt, evidence-based]
created: 2026-08-27
...
1. **Procedure e Tecniche del Terapeuta**: Azioni osservabili messe in atto dal clinico (es. ristrutturazione cognitiva, esposizione graduata, dialogo socratico, prescrizione di homework). Gli interventi non producono direttamente l'esito clinico, ma attivano i processi interni al paziente.
2. **Mediatori Statistici**: Variabili intermedie che mostrano un'associazione statistica tra intervento ed esito (Kazdin, 2007), ma che non spiegano di per sé la complessità dei percorsi causali dinamici e non lineari.
3. **Indicatori di Aderenza e Implementazione**: Misure di fedeltà al protocollo o quantità/qualità di svolgimento dei compiti (es. *homework compliance*), che riflettono l'ingaggio con le procedure ma non l'avvenuto cambiamento cognitivo/emotivo.
...
- **Principali Domini di Processo CBT**:
  - *Ristrutturazione Cognitiva e Modifica delle Credenze* (bias cognitivi, schemi disfunzionali, catastrofizzazione).
...
- Hofmann et al. (2026). [1-s2.0-S0272735826000917-main].
