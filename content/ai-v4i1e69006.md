...
- Revisione sistematica condotta secondo metodologia PRISMA che sviluppa il framework gerarchico HAICEF (*Health Care AI Chatbot Evaluation Framework*) per standardizzare la valutazione multidimensionale dei chatbot sanitari basati su IA generativa (Hua et al., 2025).
- **Utilità CBT:** Guida il clinico CBT e i ricercatori nella valutazione rigorosa di agenti conversazionali per la salute mentale, imponendo la priorità non negoziabile della sicurezza e gestione crisi (*Safety-First*) prima di validità clinica ed empatia simulata.

## Evidenze dalla Letteratura
- **Crisi Valutativa nell'Era dell'IA Generativa:** Il mercato dei chatbot sanitari ($787,1 milioni nel 2022, CAGR stimato del 23,9% dal 2023 al 2030) è trainato da [large-language-models](large-language-models.md) (LLM) generativi a output dinamico e non vincolato; la letteratura pregressa risultava frammentata in framework isolati e limitati a metriche superficiali di gradimento o task completion (Hua et al., 2025).
- **Sintesi Metodologica e Struttura di HAICEF:** Dalla sintesi di 11 framework e 356 quesiti iniziali, gli autori hanno derivato **271 domande operative** organizzate su **3 livelli gerarchici di priorità** (ispirati alla piramide di Maslow e al framework per app APA), comprendenti **18 macro-costrutti** e **60 costrutti granulari** (56 coperti da domande specifiche) (Hua et al., 2025).
- **Principio "Safety-First" e Discrepanza della Letteratura:** Il 40% delle domande dei framework preesistenti si concentrava su *Design and Operational Effectiveness* e il 39% su *Trustworthiness and Usefulness*, trascurando la base di *Safety, Privacy, and Fairness* (21%). HAICEF stabilisce che sicurezza, privacy (HIPAA/GDPR) ed equità sono condizioni preliminari vincolanti (Hua et al., 2025).
- **Rischi Clinici Documentati:** La letteratura evidenzia derive iatrogene in chatbot non validati: consigli restrittivi dannosi per disturbi alimentari (Sharp, Torous, & West, 2023; caso *Tessa*), rappresentazioni stigmatizzanti o istruzioni per autolesionismo (De Freitas & Cohen, 2024; King, 2022), e disinformazione oncologica/farmacologica (Chen et al., 2023).
- **Dati di Addestramento e Bias:** La prevalenza di training data estratti dal web e social media anziché da cartelle cliniche convalidate o letteratura peer-reviewed alimenta allucinazioni e bias sistemici (Hua et al., 2025).
...
### Disegno dello Studio PRISMA e Framework Inclusi
...
Gli 11 framework inclusi nella revisione sistematica rappresentano lo stato dell'arte pre-HAICEF:
1. **Denecke & Warren (2020):** Valutazione di applicazioni sanitarie con conversational user interface (CUI).
2. **Martinengo et al. (2023):** Tassonomia e classificazione concettuale basata su interviste a esperti.
3. **Denecke & May (2023):** Tassonomia tecnica e cluster analysis degli archetipi di agenti conversazionali.
4. **Ding et al. (2024):** Framework a 4 stadi derivato dalle linee guida WHO (fattibilità, efficacia, effettività, implementazione).
...
HAICEF si articola in una struttura ad albero a tre livelli gerarchici senza assegnare punteggi monolitici (*non-scoring scaffold*), consentendo ai vari stakeholder di ponderare i costrutti secondo il contesto operativo (Hua et al., 2025).
...
### Implicazioni per la Salute Mentale, la Psicoterapia CBT e la Governance

- **Superare l'Illusion of Competence:** Nei chatbot clinici, la fluidità linguistica e l'empatia simulata (*simulated empathy*) rischiano di celare errori diagnostici o fallimenti nella gestione del rischio suicidario (Coghlan et al., 2023; Hua et al., 2025). Collocare *Safety, Privacy and Fairness* come Step 1 impone:
  1. *Protocolli di Crisi:* Meccanismi deterministici di deviazione (*critical help*) per ideazione suicidaria e psicosi acuta.
  2. *Data Provenance e Privacy:* Crittografia end-to-end e isolamento dei dati clinici dall'addestramento continuo.
  3. *Automation Bias:* Interventi per impedire che utenti vulnerabili deleghino acriticamente decisioni cliniche al bot.
- **Dualità Patient-Facing vs Back-Office:** I sistemi patient-facing richiedono massima enfasi su Step 1 (sicurezza, crisi, privacy) e Step 3 (empatia calibrata, aderenza comportamentale); i sistemi back-office esigono prioritariamente Step 2 (validità, retrieval accuracy, affidabilità del flusso EHR) e Step 1 (sicurezza informatica e HIPAA/GDPR) (Hua et al., 2025).
- **Allineamento Regolatorio:** HAICEF colma il divario operativo tra le linee guida di [CHAI](concetti/chai-blueprint-health-ai.md) e gli standard regolatori internazionali per i dispositivi medici software (**FDA SaMD** 21 CFR 820 ed **EU AI Act** / Regolamento MDR 2017/745) (Coalition for Health AI, 2023; Hua et al., 2025).
...
## Relazioni
- Vedi anche: [haicef-framework](haicef-framework.md), [chai-blueprint-health-ai](chai-blueprint-health-ai.md), [healthcare-conversational-agents](concetti/concetti/concetti\healthcare-conversational-agents.md), [five-axis-clinical-evaluation](five-axis-clinical-evaluation.md), [software-as-a-medical-device-salute-mentale](software-as-a-medical-device-salute-mentale.md), [three-layer-governance-framework](concetti/concetti/concetti\three-layer-governance-framework.md), [rlhf-safety-therapeutic-conflict](rlhf-safety-therapeutic-conflict.md), [reflective-interpretability](reflective-interpretability.md), [audit-bias-llm-clinici](concetti/concetti/concetti\audit-bias-llm-clinici.md), [modello-centauro-clinico](concetti/concetti/concetti\modello-centauro-clinico.md), [simulated-therapeutic-alliance](simulated-therapeutic-alliance.md)
